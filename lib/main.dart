...
void main() {
  runApp(first_flutter_project());
}

class first_flutter_project extends StatelessWidget {
  @override
  ...
  Widget buildButton(
    ...
    return Container(
      ...
      child: TextButton(
          ...
          child: Text(buttonText,style: const TextStyle(fontSize: 30.0,fontWeight: FontWeight.normal,color: Colors.white),)),
    );
  }
